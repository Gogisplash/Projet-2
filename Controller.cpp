...
void Controller::OnUpdate()
{
	...
	m_fps = GetKey(m_fps, sf::Keyboard::isKeyPressed(sf::Keyboard::F));
	m_god = GetKey(m_god, sf::Keyboard::isKeyPressed(sf::Keyboard::I));
	m_fire = sf::Keyboard::isKeyPressed(sf::Keyboard::LShift);
